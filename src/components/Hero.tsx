    ...
    <div
      ...
      <div className="hero-content text-neutral-content text-center">
        <div className="max-w-screen-lg">
          <h1 className="my-16 text-7xl font-bold uppercase bg-opacity-90 text-gray-800 bg-slate-200 rounded-3xl p-8">
            Clash of <br />
            <span className="italic font-serif font-extralight">
              clodo beers
            </span>
          </h1>
          <p className="mb-8 text-xl p-4  rounded-3xl text-slate-200 bg-gray-800 bg-opacity-90">
